export type RiskKind = 'equipment' | 'cash' | 'stock'
export type RiskStatus = 'unowned' | 'drafted' | 'blocked' | 'ready'
...
export type Note = { time: string; author: string; text: string; tag: string }
  ...
  return [
    {
      ...
      notes: [
        { time: '9:46 PM', author: 'Rohan · Closing lead', text: 'Walk-in fridge stayed at 9°C after the door was fixed. Called CoolTech; they said they may come tomorrow. Milk moved to the small fridge. I’m heading out.', tag: 'Equipment' },
        { time: '9:32 PM', author: 'Rohan · Closing lead', text: 'Till looks ₹420 over. I did a quick recount, but the dinner rush receipts need another look.', tag: 'Cash' },
        { time: '9:08 PM', author: 'Meera · Bar', text: 'Beans are low. Sunrise Roasters confirmed an 8:15 AM delivery.', tag: 'Stock' },
      ],
      risks: [
        { id: 'fridge', kind: 'equipment', title: 'Walk-in fridge temperature', detail: '9°C after door repair. CoolTech attendance is unconfirmed.', severity: 'critical', status: 'unowned' },
        { id: 'till', kind: 'cash', title: 'Till discrepancy', detail: '₹420 cash variance needs a count before tomorrow’s close.', severity: 'medium', status: 'blocked', owner: 'Arjun', deadline: 'Tomorrow · 5:00 PM' },
    ...
    },
    {
      ...
      notes: [
        { time: '9:02 PM', author: 'Priya · Closing lead', text: 'Oat milk supplier pushed delivery to noon instead of 7 AM. Divya knows and will use the backup case in the walk-in until it arrives.', tag: 'Stock' },
        { time: '8:40 PM', author: 'Priya · Closing lead', text: 'Till balanced exactly at close. No variance.', tag: 'Cash' },
      ],
      risks: [
